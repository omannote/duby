...
const FUNCTIONS_URL = `${import.meta.env.VITE_SUPABASE_URL ?? ''}/functions/v1/settlements`;
...
export async function callSettlementsApi<T>(path: string, body: unknown): Promise<ApiResult<T>> {
