...
المندوب يعمل وحده ولا أحد يذكّره. مهمة يومية عند نهاية يوم العمل (بتوقيت مسقط)
تدرج في Outbox تذكيرًا لكل مندوب له تسوية `open`:

```
لديك نقد غير مودَع بقيمة 18.750 ر.ع لتاريخ 2026-09-16.
يرجى إيداعه في حساب الشركة وتوثيق الإيصال من التطبيق.
```
