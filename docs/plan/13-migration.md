...
| D7 | **طريقة التسليم الافتراضية** | إيداع بنكي / مكتب / خزنة | الإيداع البنكي حيثما أمكن — هو الوحيد الذي له مصدر تحقق مستقل عنّا وعن المندوب |
...
`handover_method = 'office_handover'` لأنه لا يتطلب إثباتًا مصوَّرًا — ولا يوجد
إثبات لعمليات سابقة للنظام.
